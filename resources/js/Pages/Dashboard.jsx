    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {/* ── Welcome Section ── */}
                <div className="mb-8 rounded-2xl bg-white/10 backdrop-blur-sm p-6 border border-white/10">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div className="flex gap-3">
                            <Link
                                href="/book_now"
                                className="rounded-full bg-white px-6 py-2 text-sm font-semibold text-gray-900 transition hover:bg-gray-200"
                            >
                                📅 Book a Court
                            </Link>
                            <Link
                ...
                <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                    ...
                    <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-6 text-center border border-white/10">
                        ...
                        <p className="text-sm text-gray-300">Classes Attended</p>
                    </div>
                    <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-6 text-center border border-white/10">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-6 border border-white/10">
                        ...
                        {upcomingBookings.length > 0 ? (
                            ...
                            <p className="text-center text-gray-400">No upcoming bookings.</p>
                        )}
                    </div>
                    ...
                    <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-6 border border-white/10">
                        ...
                        {activeClasses.length > 0 ? (
                            ...
                            <p className="text-center text-gray-400">No active classes.</p>
                        )}
                    </div>
                ...
                {/* ── Quick Actions ── */}
                <div className="mt-8 rounded-2xl bg-white/10 backdrop-blur-sm p-6 border border-white/10">
